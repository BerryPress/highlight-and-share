					...
					<div className="has-admin-content-wrapper">
						<div className="has-admin-content-panel">
							<div className="has-admin-content-heading">
								...
								{
									( ! getValues( 'recaptchaEnabled' ) && ! getValues( 'turnstileEnabled' ) && 'mailto' !== getValues( 'emailSendType' ) ) && (
										<Notice
											message={ __( 'The email option will not be available for security reasons until you enable at least one captcha service or use the mailto option.', 'highlight-and-share' ) }
											status="error"
											politeness="assertive"
											inline={ false }
										/>
