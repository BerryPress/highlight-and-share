...
var _HAS_Click_To_Share = function HAS_Click_To_Share(props) {
  ...
  var inspectorControls = /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement("div", {
    ...
    screenSize: deviceType,
    onValuesChange: function onValuesChange(newValues) {
      var paddingValues = _objectSpread({}, paddingSize);
      var newValue = newValues[deviceType.toLowerCase()];
      if (newValue) {
    ...
    screenSize: deviceType,
    onValuesChange: function onValuesChange(newValues) {
      var marginValues = _objectSpread({}, marginSize);
      var newValue = newValues[deviceType.toLowerCase()];
      if (newValue) {
    ...
    screenSize: deviceType,
    onValuesChange: function onValuesChange(newValues) {
      var borderWidthValues = _objectSpread({}, borderWidth);
      var newValue = newValues[deviceType.toLowerCase()];
      if (newValue) {
    ...
    screenSize: deviceType,
    onValuesChange: function onValuesChange(newValues) {
      var borderRadiusValues = _objectSpread({}, borderRadiusSize);
      var newValue = newValues[deviceType.toLowerCase()];
      if (newValue) {
