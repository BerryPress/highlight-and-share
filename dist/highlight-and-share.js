...
(function () {
  ...
  var socialNetworks = HAS.social_network_classes || '.has_whatsapp, .has_facebook, .has_twitter, .has_copy, .has_reddit, .has_telegram, .has_linkedin, .has_xing, .has_signal, .has_vk, .has_tumblr, .has_mastodon, .has_email_mailto, .has_email_form, .has_threads, .has_bluesky, .has_webshare';
  ...
  var hasDisplay = function hasDisplay(text, title, href, hashtags, type) {
    ...
    hasClone.querySelectorAll('a').forEach(function (a) {
    ...
    var allNetworkElements = hasClone.querySelectorAll(socialNetworks);
    allNetworkElements.forEach(function (el) {
      if (!isVisible(el)) {
        return;
      }
      el.addEventListener('mousedown', function () {
        (0,_stats_dispatcher__WEBPACK_IMPORTED_MODULE_1__.dispatchStatsEvent)({
          hasShareText: text,
    ...
    var queryElements = hasClone.querySelectorAll('.has_whatsapp, .has_facebook, .has_twitter, .has_telegram, .has_linkedin, .has_xing, .has_reddit, .has_tumblr, .has_threads, .has_bluesky');
    if (null !== queryElements) {
      queryElements.forEach(function (el) {
        if (isVisible(el)) {
    ...
    var copyButtons = hasClone.querySelectorAll('.has_copy');
    if (null !== copyButtons) {
    ...
    var emailButtons = hasClone.querySelectorAll('.has_email_form');
     ...
     */
    var mastodonButtons = hasClone.querySelectorAll('.has_mastodon');
    ...
    var webshareButtons = hasClone.querySelectorAll('.has_webshare');
